									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											...
											<c:if test="${not empty objSlide}">
												<p class="help-block"><em>Old Image: <img width="50px" height="50px" src="${pageContext.request.contextPath}/pathUrl/files/${objSlide.slide}" alt="Ảnh củ"/></em></p>
											</c:if>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input name="sort" value='<c:if test="${not empty objSlide.sort}">${objSlide.sort}</c:if>' type="number" class="form-control" id="sort" placeholder="500">
										</div>
									</div>
