...
public class Data {
	...
	public Data(int data_id, int json_id, int wind_dir, int uv, int moon_phase, int moonrise_ts, int moonset_ts,
			int sunrise_ts, int sunset_ts, int ts, Timestamp valid_date, Timestamp date_time, String wind_cdir,
	...
	public String toString() {
		return "Data [data_id=" + data_id + ", json_id=" + json_id + ", wind_dir=" + wind_dir + ", uv=" + uv
				...
				+ valid_date + ", date_time=" + date_time + ", wind_cdir=" + wind_cdir + ", wind_cdir_full="
